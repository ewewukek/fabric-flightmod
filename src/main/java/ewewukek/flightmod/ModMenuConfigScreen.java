...
public class ModMenuConfigScreen implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            Text title = Config.currentServer != null ? new TranslatableText("flightmod.options.for", new LiteralText(Config.currentServer))
                                                      : new TranslatableText("flightmod.options.for.singleplayer");
            ...
            if (Config.currentServer == null) {
                category.addEntry(entryBuilder.startBooleanToggle(
                    new TranslatableText("flightmod.options.server.enable_flying"), Config.enableFlying)
                    .setSaveConsumer(value -> Config.enableFlying = value)
                    .setDefaultValue(Config.ENABLE_FLYING_DEFAULT)
                    .build());

                category.addEntry(entryBuilder.startBooleanToggle(
                    new TranslatableText("flightmod.options.server.enable_fall_damage"), Config.doFallDamage)
                    .setSaveConsumer(value -> Config.doFallDamage = value)
                    .setDefaultValue(Config.DO_FALL_DAMAGE_DEFAULT)
                    .build());

                category.addEntry(entryBuilder.startBooleanToggle(
                    new TranslatableText("flightmod.options.server.fly_in_water"), Config.flyInWater)
                    .setSaveConsumer(value -> Config.flyInWater = value)
                    .setDefaultValue(Config.FLY_IN_WATER_DEFAULT)
                    .build());

                category.addEntry(entryBuilder.startBooleanToggle(
                    new TranslatableText("flightmod.options.server.fly_in_lava"), Config.flyInLava)
                    .setSaveConsumer(value -> Config.flyInLava = value)
                    .setDefaultValue(Config.FLY_IN_LAVA_DEFAULT)
                    .build());

                category.addEntry(entryBuilder.startBooleanToggle(
                    new TranslatableText("flightmod.options.server.fly_in_slow_blocks"), Config.flyInSlowBlocks)
                ...
                category.addEntry(entryBuilder.startFloatField(
                    new TranslatableText("flightmod.options.server.flying_cost"), Config.flyingCost)
                ...
                category.addEntry(entryBuilder.startFloatField(
                    new TranslatableText("flightmod.options.server.flying_horizontal_cost"), Config.flyingHorizontalCost)
                ...
                category.addEntry(entryBuilder.startFloatField(
                    new TranslatableText("flightmod.options.server.flying_up_cost"), Config.flyingUpCost)
                ...
                category.addEntry(entryBuilder.startIntSlider(
                    new TranslatableText("flightmod.options.server.food_level_warning"), Config.foodLevelWarning, -1, 10)
            ...
            category.addEntry(entryBuilder.startEnumSelector(
                new TranslatableText("flightmod.options.client.movement_mode"), Config.MovementMode.class, Config.movementMode)
                ...
                .setEnumNameProvider(value -> new TranslatableText("flightmod.options.client.movement_mode." + value))
                .build());

            category.addEntry(entryBuilder.startBooleanToggle(
                new TranslatableText("flightmod.options.client.compensate_side_inertia"), Config.compensateSideInertia)
            ...
            category.addEntry(entryBuilder.startBooleanToggle(
                new TranslatableText("flightmod.options.client.air_jump_fly"), Config.airJumpFly)
            ...
            category.addEntry(entryBuilder.startBooleanToggle(
                new TranslatableText("flightmod.options.client.sneak_jump_drop"), Config.sneakJumpDrop)
